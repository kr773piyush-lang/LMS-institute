...
exports.addCourse = asyncHandler(async (req, res) =>
  res.status(201).json(await service.createCourse(req.body, req.tenant, req.user))
);
...
exports.editCourse = asyncHandler(async (req, res) =>
  res.json(await service.updateCourse(req.params.courseId, req.body, req.tenant, req.user))
);
...
exports.addSubcourse = asyncHandler(async (req, res) =>
  res.status(201).json(await service.createSubcourse(req.body, req.tenant, req.user))
);
...
exports.editSubcourse = asyncHandler(async (req, res) =>
  res.json(await service.updateSubcourse(req.params.subcourseId, req.body, req.tenant, req.user))
);
