...
exports.courseWorkspace = asyncHandler(async (req, res) =>
  res.json(await service.getCourseWorkspace(req.params.courseId, req.query.category, req.user, req.tenant))
);
