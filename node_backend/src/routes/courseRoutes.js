...
router.use(protect);
router.post("/courses", allowRoles("super_admin", "institute_admin"), validate(courseSchema), controller.addCourse);
router.get("/courses", allowRoles("super_admin", "institute_admin", "teacher", "student"), controller.getCourses);
router.put("/courses/:courseId", allowRoles("super_admin", "institute_admin"), validate(courseSchema), controller.editCourse);
router.delete("/courses/:courseId", allowRoles("super_admin", "institute_admin"), controller.removeCourse);

router.post("/subcourses", allowRoles("super_admin", "institute_admin"), validate(subcourseSchema), controller.addSubcourse);
router.get("/subcourses", allowRoles("super_admin", "institute_admin", "teacher", "student"), controller.getSubcourses);
router.put("/subcourses/:subcourseId", allowRoles("super_admin", "institute_admin"), validate(subcourseSchema), controller.editSubcourse);
